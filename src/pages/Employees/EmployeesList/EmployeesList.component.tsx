      ...
      <MainWrapper>
        <div className="employees">
          <Grid container spacing={3}>
            <Grid item xs={8}>
              <Typography variant="h5" className="mg-10 color-primary">
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>
                      {i18n.t('employees.table.header.photo')}
                    </TableCell>
                    <TableCell>
                      {i18n.t('employees.table.header.employeeName')}
                    </TableCell>
                    <TableCell>
                      {i18n.t('employees.table.header.role')}
                    </TableCell>
                    <TableCell>
                      {i18n.t('employees.table.header.address')}
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  ...
                  {!isEmpty(dataEmployees) &&
                    map(
                      dataEmployees,
                      (data: IEmployee, index: number): ReactNode => (
                        <TableRow
                          key={index}
                          onClick={this.onEditEmployee(data)}
                        >
