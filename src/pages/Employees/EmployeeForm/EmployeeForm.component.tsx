...
export class EmployeeForm extends Component<IProps> {
  ...
  public employeeForm = (
    formikProps: FormikProps<IEmployeeFormValues>
  ): ReactNode => {
    return (
          ...
          <Buttons
            ...
            text={
              !!formikProps.values.id
                ? i18n.t('employees.form.update')
                : i18n.t('employees.form.add')
            }
            color="primary"
          />
        </Grid>
      ...
      <>
        <div className="employee-form">
          <FormDrawer openDrawer={openForm} closeAndResetForm={this.closeForm}>
            ...
            >
              {employee
                ? i18n.t('employees.form.edit')
                : i18n.t('employees.form.create')}
            </Typography>
            <Divider />
            <br />
            <Formik
