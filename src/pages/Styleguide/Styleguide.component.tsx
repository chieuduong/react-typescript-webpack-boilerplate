    ...
    return (
      <MainWrapper>
        <div className="styleguide">
          <Typography variant="h5" className="color-primary mg-20">
            {i18n.t('styleguide.title')}
          </Typography>
          <Grid container spacing={3}>
            <Grid item xs={12}>
              <Typography variant="h6" className="mg-10 color-primary">
                {i18n.t('styleguide.content.grid')}
              </Typography>
            </Grid>
          </Grid>
          <Grid container spacing={3}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12}>
              <Typography variant="h6" className="mg-10 color-primary">
                {i18n.t('styleguide.content.buttons')}
              </Typography>
            </Grid>
          </Grid>
          <Grid container spacing={3}>
            <Grid item xs={12}>
              ...
              <Buttons icon={<AddCircle />} text="With Icons" color="primary" />
              <Fab
                size="small"
                color="primary"
                aria-label="add"
          ...
          <Grid container spacing={3}>
            <Grid item xs={12}>
              <Typography variant="h6" className="mg-10 color-primary">
                {i18n.t('styleguide.content.loading')}
              </Typography>
            </Grid>
          </Grid>
          <Grid container spacing={3}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12}>
              <Typography variant="h6" className="mg-10 color-primary">
                {i18n.t('styleguide.content.typo')}
              </Typography>
            </Grid>
          </Grid>
          <Grid container spacing={3}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12}>
              <Typography variant="h6" className="mg-10 color-primary">
                {i18n.t('styleguide.content.table')}
              </Typography>
            </Grid>
          </Grid>
          <Grid container spacing={3}>
